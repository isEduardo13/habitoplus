...
public class GroupMemberController {
	...
	public ResponseEntity<?> update(@RequestBody GroupMember groupMember, @PathVariable Integer idGroupMember) {
		GroupMember auxGroupMember = service.getByIdGroupMember(idGroupMember);
		groupMember.setIdGroupMember(auxGroupMember.getIdGroupMember());
		service.save(groupMember);
